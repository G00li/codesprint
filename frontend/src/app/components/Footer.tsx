      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-10 md:mb-0 md:max-w-xs">
            ...
            <p className="text-gray-300 mb-4">
              Uma plataforma inovadora que utiliza inteligência artificial para gerar 
              projetos personalizados para desenvolvedores.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-gray-800 hover:bg-gray-700 flex items-center justify-center transition-colors" aria-label="GitHub">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
            <div>
              <h4 className="text-lg font-semibold mb-4 text-white relative inline-block">
                Links Rápidos
                <span className="absolute -bottom-1 left-0 w-10 h-0.5 bg-blue-500"></span>
              </h4>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-4 text-white relative inline-block">
                Recursos
                <span className="absolute -bottom-1 left-0 w-10 h-0.5 bg-green-500"></span>
              </h4>
              <ul className="space-y-3">
                <li>
                  <Link 
                ...
                <li>
                  <Link 
                    href="https://github.com/seu-usuario/codesprint" 
                    target="_blank" 
                    className="text-gray-300 hover:text-white transition-colors flex items-center"
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} CodeSprint. Todos os direitos reservados.
          </p>
          <div className="flex space-x-6">
            <a href="#" className="text-gray-400 hover:text-gray-300 text-sm">Termos de Uso</a>
            <a href="#" className="text-gray-400 hover:text-gray-300 text-sm">Privacidade</a>
