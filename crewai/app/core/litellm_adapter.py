...
class CustomLiteLLM:
    def __init__(self):
        ...
        os.environ["LITELLM_MODEL_NAME"] = "ollama/llama3:8b"  # Formato correto com provider
    ...
    def chat(self, messages):
        ...
        try:
            ...
            response = completion(
                model="ollama/llama3:8b",  # Nome completo do modelo com o provider
                api_base="http://ollama:11434",  # URL do serviço Ollama
                messages=messages,
                temperature=0.3,
                max_tokens=500,  # Limitar o tamanho da resposta
                timeout=30  # Timeout específico para a chamada
            )
